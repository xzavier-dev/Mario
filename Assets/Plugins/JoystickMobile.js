...
static private var joysticks : JoystickMobile[];					// A static collection of all joysticks
...
{	
	if ( !enumeratedJoysticks )
	{
		...
		joysticks = FindObjectsOfType( JoystickMobile ) as JoystickMobile[];
	...
	else
	{
		for(var i : int = 0;i < count; i++)
		{
			...
			if ( shouldLatchFinger && ( lastFingerId == -1 || lastFingerId != touch.fingerId ) )
			{
				...
				for ( var j : JoystickMobile in joysticks )
				{
					if ( j != this )
