...
private var playerInputControl : PlayerInputControl;

function Awake () {
	controller = GetComponent (CharacterController);
	tr = transform;

	playerInputControl = gameObject.GetComponent("PlayerInputControl");
...
function SetVelocity (velocity : Vector3) {
    ...
    // i just get this piece of code from FPSInputController.js script

    // !!!!!!!!!!!!!!!!!!!!! Note: when you build to mobile platform , you shuld process the input specificly , solve js call c# problem
    function InputControl(){

        //var directionVector = new Vector3(Input.GetAxis("Horizontal"), 0, 0);
        var directionVector = new Vector3(playerInputControl.xAxis,0,0);
        ...
        this.inputMoveDirection = transform.rotation * directionVector;
        
        //this.inputJump = Input.GetButton("Jump");
        this.inputJump = playerInputControl.jump;
...
@script RequireComponent (PlayerInputControl)
